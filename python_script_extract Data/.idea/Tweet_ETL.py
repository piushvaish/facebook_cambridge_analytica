...
def load_api():
    ...
    consumer_secret = 'ENTER YOUR OWN SECRET KEY'
    access_token = 'ENTER YOUR OWN ACCESS TOKEN'
    access_secret = 'ENTER YOUR OWN ACCESS SECRET TOKEN'
...
def main():
    ...
    ''' search variables: '''
    search_phrases = ['Facebook']
    time_limit = .0001                           # runtime limit in hours
    #######################
    ...
    ############################################
    ##change the days
    min_days_old, max_days_old = 1, 10         # search limits e.g., from 7 to 8
    ...
    for search_phrase in search_phrases:
            ...
            if tweets:
                ...
                if exitcount == 3:
                    if search_phrase == search_phrases[-1]:
                        ...
                        break
        tweet_facebook = pd.read_json(json_file_root + '_' + day + '.json', lines=True)
        ...
        df1[df1.duplicated]  #### There are no duplicates
        ...
        writer = ExcelWriter('transformed_tweets.xlsx')
